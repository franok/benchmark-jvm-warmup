...
# openj9-aot
#~/jvm-evaluation/openj9_jdk-11.0.8+10/bin/java -XX:+HeapDumpOnOutOfMemoryError -jar target/benchmarks.jar Backtracking -jvmArgs "-Xms5g -Xmx5g -XX:+HeapDumpOnOutOfMemoryError -Xgcpolicy:nogc -Xshareclasses:nonpersistent,verboseAOT -Xjit:count=0,verbose={compileEnd|inlining|compileTime},vlog=jitwatch-vlog" -rf json -rff jmh-result-openj9-backtracking-sudoku.json -i 21000 -f 1 -to 360m | tee output-openj9-backtracking-sudoku-$(date +'%FT%H-%M').log
